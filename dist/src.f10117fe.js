...
var answerOriginalFontSize = 45;
var maximumDigitBeforeSizeChange = 8;
var percentageDecrease = 0.1;
var equationFontSizeChange = equationOriginalFontSize;
var answerFontSizeChange = answerOriginalFontSize;
...
var checkDecreaseFontSize = function checkDecreaseFontSize(displayString, fontSize) {
  if (displayString.length > maximumDigitBeforeSizeChange) {
...
var decreaseFontSize = function decreaseFontSize(stringlengthOfTemporarygth, fontSize) {
  var residuallengthOfTemporarygth = stringlengthOfTemporarygth - maximumDigitBeforeSizeChange;
  ...
  var _loop_1 = function _loop_1(operationButton) {
    operationButton.addEventListener('click', function () {
      if (operationButton.id === 'equals') {
        ...
        answerFontSizeChange = checkDecreaseFontSize(outputScreen.value, answerOriginalFontSize);
        outputScreen.style.fontSize = "".concat(answerFontSizeChange, "px");
      }
    });
  };
